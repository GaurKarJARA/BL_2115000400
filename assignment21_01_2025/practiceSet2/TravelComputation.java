...
class TravelComputation {
	public static void main(String[] args) {
    	...
    	System.out.println("Traveler " + name + " traveled from " + fromCity + " to " + toCity +" via " + viaCity + ". The total distance covered is " + totalDistance +" miles and total time taken is " + totalTime + " minutes.");
	}
}
