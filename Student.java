...
class StudentRecordManagement {
    ...
    public static void main(String[] args) {
        ...
        srm.addStudentAtEnd(333, "gaurav", 22, "A");
        srm.addStudentAtEnd(702, "whoever", 0, "b");
        srm.addStudentAtBeginning(780, "sheesh", 9, "A");
        srm.displayStudents();
        srm.updateStudentGrade(333, "A+");
        srm.deleteStudent(780);
        srm.displayStudents();
    }
}
