...
public class InsurancePolicyManagement {
    ...
    public static void main(String[] args) throws Exception {
        ...
        manager.addPolicy(new Policy("A01", "gaurav", sdf.parse("2024-03-12"), "Health",250.0));
        manager.addPolicy(new Policy("A02", "Pranjal", sdf.parse("2024-04-18"), "Auto", 150.0));
        manager.addPolicy(new Policy("A03", "Panda", sdf.parse("2024-02-28"), "Home", 220.0));
        ...
        System.out.println("\nPolicies for gaurav:");
        System.out.println(manager.getPoliciesByHolder("gaurav"));
