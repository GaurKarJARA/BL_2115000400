...
public class DynamicOnlineMarketplace {
    public static void main(String[] args) {
        Product<BookCategory> book1 = new Product<>("The Alchemist", 15, BookCategory.FICTION);
        Product<BookCategory> book2 = new Product<>("picture For picture", 49, BookCategory.EDUCATIONAL);

        Product<ClothingCategory> shirt = new Product<>("T-Shirt", 15.00, ClothingCategory.MEN);
        Product<ClothingCategory> dress = new Product<>(" Dress", 6.00, ClothingCategory.WOMEN);
