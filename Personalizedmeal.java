...
public class Personalizedmeal {
    public static void main(String[] args) {
        ...
        vegetarianPlan.addMeal(new VegetarianMeal("parantha"));
        vegetarianPlan.addMeal(new VegetarianMeal("fry rice"));
        Meal<VeganMeal> veganPlan = new Meal<>();
        veganPlan.addMeal(new VeganMeal("biryani"));
        veganPlan.addMeal(new VeganMeal("cake"));
        ...
        PersonalizedMealPlanGenerator.generateMealPlan(vegetarianPlan.getMeals());

        System.out.println("\nVegan Meal Plan:");
        PersonalizedMealPlanGenerator.generateMealPlan(veganPlan.getMeals());

        System.out.println("\nKeto Meal Plan:");
        PersonalizedMealPlanGenerator.generateMealPlan(ketoPlan.getMeals());

        System.out.println("\nHigh-Protein Meal Plan:");
        PersonalizedMealPlanGenerator.generateMealPlan(highProteinPlan.getMeals());
    }
}
