...
class SoftwareEngineer extends JobRole {
    ...
    public void displayResume() {
        System.out.println("Software Engineer Resume - " + getCandidateName() +  " | Experience: " + getYearsOfExperience() + " years" + " | Skill Score: " + getSkillScore());
    }
}
class DataScientist extends JobRole {
    ...
    @Override
    public void displayResume() {
        System.out.println("Data Scientist Resume - " + getCandidateName() +    " | Experience: " + getYearsOfExperience() + " years" +" | Skill Score: " + getSkillScore());
    }
}
class ProductManager extends JobRole {
    ...
    @Override
    public void displayResume() {
        System.out.println("Product Manager Resume - " + getCandidateName() + " | Experience: " + getYearsOfExperience() + " years" + " | Skill Score: " + getSkillScore());
    }
}
...
public class ResumeScreeningg{
    public static void main(String[] args) {
        ...
        softwareEngineerResumes.addResume(new SoftwareEngineer("Alice ", 5, 8.5));
        softwareEngineerResumes.addResume(new SoftwareEngineer("Bob ", 2, 6.0));
        Resume<DataScientist> dataScientistResumes = new Resume<>();
        dataScientistResumes.addResume(new DataScientist("Charlie", 4, 7.5));
        dataScientistResumes.addResume(new DataScientist("Diana ", 6, 9.0));
        Resume<ProductManager> productManagerResumes = new Resume<>();
        productManagerResumes.addResume(new ProductManager("Ethan", 8, 9.2));
        productManagerResumes.addResume(new ProductManager("Fiona", 3, 5.5));
        System.out.println("Software Engineer Resume Screening:");
        AIdrivenResumeScreening.screenResumes(softwareEngineerResumes.getAllResumes(), 3, 7.0);
        System.out.println("Data Scientist Resume Screening:");
        AIdrivenResumeScreening.screenResumes(dataScientistResumes.getAllResumes(), 4, 7.5);
        System.out.println("Product Manager Resume Screening:");
        AIdrivenResumeScreening.screenResumes(productManagerResumes.getAllResumes(), 5, 8.0);
    }
}
