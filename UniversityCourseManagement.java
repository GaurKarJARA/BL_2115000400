...
public class UniversityCourseManagement{
    public static void main(String[] args) {
        ExamCourse science = new ExamCourse("science", "Dr. Smith", 100);
        ExamCourse coding = new ExamCourse("coding", "Dr. Brown", 150);

        AssignmentCourse history = new AssignmentCourse("history", "Dr. Johnson", 5);
        AssignmentCourse economics = new AssignmentCourse("Economics", "Dr. White", 7);
        ...
        examCourseCatalog.addCourse(science);
        examCourseCatalog.addCourse(coding);

        Course<AssignmentCourse> assignmentCourseCatalog = new Course<>();
        assignmentCourseCatalog.addCourse(history);
        assignmentCourseCatalog.addCourse(economics);
